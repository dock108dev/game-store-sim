...
- [ ] Start a new store.
- [ ] Enter from the mall/storefront route.
...
- [ ] Maintain reputation through returns, services, and launch fulfillment.
- [ ] Expand catalog access through trust/progression, not just cash.
...
- [ ] Keep suspicious contacts optional and out of the normal sales queue.
...
The 100% state is not just every checklist item. It is a mature store that still works as a business:

- the store is visually credible

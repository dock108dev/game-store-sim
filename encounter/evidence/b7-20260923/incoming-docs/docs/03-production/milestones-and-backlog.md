...
| Motion improvement | Required for first-week beta; retain current art style, define and verify changes in B7 alongside implementation. |
...
B3 was separately authorized for runtime/UI and isolated verification, preserving incoming B1/B2 sources and evidence. B3 technical completion does not supply R5/B2/B3 owner acceptance. B4 and B5 were subsequently authorized and delivered; stop before B7.

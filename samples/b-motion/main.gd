extends Node2D
const SAMPLE = "B-ROWAN-01 / review-v3"
const SPEED = 72.0
const CYCLE = 0.72
var actor: Node2D
var rigs = {}
...
func _ready() -> void:
 ...
 polygon(self, PackedVector2Array([Vector2(95,620),Vector2(1120,620),Vector2(1200,200),Vector2(195,200)]), Color("d8d2c5"))
 ...
 polygon(shelf, PackedVector2Array([Vector2(-125,-90),Vector2(100,-90),Vector2(125,-115),Vector2(-100,-115)]), Color("a89b82"))
 polygon(shelf, PackedVector2Array([Vector2(-125,-90),Vector2(100,-90),Vector2(100,0),Vector2(-125,0)]), Color("736f60"))
 polygon(shelf, PackedVector2Array([Vector2(100,-90),Vector2(125,-115),Vector2(125,-25),Vector2(100,0)]), Color("5c6157"))
 for y in [-68,-36]:
  polygon(shelf,PackedVector2Array([Vector2(-115,y),Vector2(90,y),Vector2(90,y+5),Vector2(-115,y+5)]),Color("a89b82"))
 actor = Node2D.new()
 ...
 add_child(marker)
 label_at("ONE CUSTOMER / MOTION STUDY",Vector2(55,36),15,Color("657265"))
 label_at("An illustrated shop overview",Vector2(55,64),30,Color("293d38"))
 ...
 label_at(SAMPLE,Vector2(950,40),14,Color("657265"))

...
- Keep preorder deposits, allocation commitments, launch-day queue, and reputation consequences out of this slice until the calendar can be validated in normal play.
...
- Keep named validation screenshots current for main scene, receiving area, supplier message, suspicious customer, register counter, customer queue, trade-in offer, backroom summary, release calendar, supplier delivery, fixture ghost preview, invalid fixture ghost preview, rotated fixture ghost preview, and placed fixture.

...
11. Hidden-thread production arc. Current phase; clue surfaces done through Stop 10.2.
...
- Done: synced hidden-thread scenario coverage, manual Hidden Thread Focus checks, validation baselines, and Milestone 10 status for Stop 10.2.
- Remaining polish risk: Stop 10.3 still needs choice points such as ignore, document, sell, isolate, report, accept cash, reject goods, and follow-up paths.

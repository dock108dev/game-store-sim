...
- `scenarios/day_summary.json`: store session cash accounting, recent activity history, active inventory summary, backroom computer, and day summary panel checks.

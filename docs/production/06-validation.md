...
- `scripts/validate_godot.sh` passes with 317 GUT tests.
- UI scenario automation coverage is 321/378, above the required 80% threshold.
- Production script mapping coverage is 33/33.

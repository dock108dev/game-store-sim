...
- Full validation snapshot is `scripts/validate_godot.sh` passing with 532 GUT tests, UI scenario automation coverage 485/604, production script mapping coverage 51/51, 3 active validation tools, 33 catalog products, desktop pack smoke, alpha performance smoke, screenshot sanity checks, and old-name scan.

...
- Full validation snapshot is `scripts/validate_godot.sh` passing with 563 GUT tests, UI scenario automation coverage 508/628, production script mapping coverage 52/52, 3 active validation tools, 60 catalog products, desktop pack smoke, alpha performance smoke, screenshot sanity checks, and old-name scan.

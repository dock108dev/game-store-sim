...
- The full local gate is green with 553 GUT tests, 508/628 UI scenario automation coverage, 52/52 production script mapping coverage, desktop pack smoke, alpha performance smoke, screenshot sanity, and old-name scan.

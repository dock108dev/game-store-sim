# Replay Junction UI design requirements
...
- Use familiar words and sentence case. “Apply price” is clearer than “Execute action”. Explain blocked actions in terms of what the player or user can do next.
- Keep useful labels, units, dates and status distinctions. “Price per copy” is clearer than “Value”.
...
Retain the cool, light glass direction: system typography, slate text, blue actions, restrained translucency and depth. Use `encounter/glass_ui.gd` for the implemented theme.

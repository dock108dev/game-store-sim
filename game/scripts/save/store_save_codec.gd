...
func restore_into_existing_scene(
	...
	var service_tickets_value: Variant = data.get("service_tickets", [])
	...
	var management_reviews_value: Variant = data.get("management_reviews", [])
	...
	var purchased_decorations_value: Variant = data.get("purchased_decorations", [])
	...
	var hidden_thread_choices_value: Variant = data.get("hidden_thread_choices", [])
